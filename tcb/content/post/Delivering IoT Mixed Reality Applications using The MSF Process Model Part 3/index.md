...
1. [Part 1](/post/delivering-iot-mixed-reality-applications-using-the-msf-process-model-develop-stabilize-and-deploy-part-1/): An overview of the MSF and the Envisioning and Planning phases of delivering the solution.
2. [Part 2](post/delivering-iot-mixed-reality-applications-using-the-msf-process-model-develop-stabilize-and-deploy-part-2/): The development and deployment of the backend of the solution.
